...
<?php
	...
	$user_name=$_SESSION['login'];
        ...
        $check_time_admin = "SELECT  admin_booking.stu_id FROM admin_booking inner join booking ON  booking.booking_id = admin_booking.booking_id AND booking.booking_day LIKE '%".$datetime->format('Y-m-d')."%' where booking.user_name = '$user_name_st'  and booking.booking_status='1' and booking.booking_in = '$t' or admin_booking.stu_id = '$user_name_st' and booking.booking_status='1' and booking.booking_in = '$t' or booking.user_name = '$user_name_st'  and booking.booking_status='2' and booking.booking_in = '$t' or admin_booking.stu_id = '$user_name_st' and booking.booking_status='2' and booking.booking_in = '$t'";
        ...
        $check_time = "SELECT * FROM `booking` where user_name = '$user_name_st' and booking_day='".$datetime->format('Y-m-d')."' and  booking_status= '1' and booking_in = '$t' or  user_name = '$user_name_st' and booking_day='".$datetime->format('Y-m-d')."' and  booking_status= '2' and booking_in = '$t'";
        ...
        if($count_check_time>='1'){
                ...
                $query_booking = "SELECT * FROM `booking` where user_name = '$user_name_st' and booking_day='".$datetime->format('Y-m-d')."' and  booking_status= '1' or  user_name = '$user_name_st' and booking_day='".$datetime->format('Y-m-d')."' and  booking_status= '2'";
                
                $result2=mysqli_query($con,$query_booking);
                $count_hr_admin=mysqli_num_rows($result2);
                
    
                            $query_room = "SELECT  admin_booking.stu_id FROM admin_booking inner join booking ON  booking.booking_id = admin_booking.booking_id AND booking.booking_day LIKE '%".$datetime->format('Y-m-d')."%' where booking.user_name = '$user_name_st'  and booking.booking_status='1' or admin_booking.stu_id = '$user_name_st' and booking.booking_status='1' or booking.user_name = '$user_name_st'  and booking.booking_status='2' or admin_booking.stu_id = '$user_name_st' and booking.booking_status='2' ";
                ...
                if($count_all>='3'){
                    ...
                    if($count_all>='3'){
                            ...
                            $query_room1 = "SELECT * FROM `booking` where  booking_day LIKE '%".$datetime->format('Y-m-d')."%' and user_name = '$user_name_st' and booking_status='1' or booking_day LIKE '%".$datetime->format('Y-m-d')."%' and user_name = '$user_name_st' and booking_status='2'";
                            $result_room1=mysqli_query($con,$query_room1);
                            $count_hr1=mysqli_num_rows($result_room1);        
                        
                           if($count_hr1==null){
                        
                            $sql_booking = "INSERT INTO `booking` (`booking_id`, `room_id`, `booking_day`, `booking_in`, `booking_out`, `booking_date`, `booking_status`, `user_name`) VALUES (NULL, '$room_id', '".$datetime->format('Y-m-d')."', '$t', '$o', Now(), '0', '$user_name');";
