...
<?php 
  ...
  ?>
    <div class="container">
        <center>
        <h1 id="headd" style="color:green">รายการจองห้องของคุณ</h1>
        ...
        <div id="wss">
            ...
            $user_name=$_SESSION['login'];
                ...
                $i=0;
                $query_user_all = "SELECT * FROM admin_booking RIGHT join booking ON booking.booking_id = admin_booking.booking_id WHERE booking.user_name = '$user_name' and booking.booking_status = '1' or admin_booking.stu_id = '$user_name' and booking.booking_status = '1'";
                                          ...
                                          if($stu_id=='adminadmin'){
                                            ...
                                            echo  '
                                                        <tr>
                                                         ...
                                                         <td id="thh">'.$booking_in.'</td>
                                                         <td id="thh">'.$booking_out.'</td>';
